                ...
                <div class="col-span-4 lg:text-center lg:pt-14 mb-10">
                    ...
                    <div class="flex items-center lg:justify-center text-sm mt-4">
                        ...
                        <div class="ml-3 text-left">
                            <h5 class="font-bold">
                                <a href="?author={{ $post->author->username }}" title="">{{ $post->author->name }}</a>
                            </h5>
                        </div>
                    </div>
                </div>
                ...
                <section class="col-span-8 col-start-5 mt-10">
                    @auth
                        <form method="POST" action="/posts/{{ $post->slug }}/comments" class="border border-gray-200 p-6 rounded-xl mb-4">
                            ...
                            <div class="mt-6">
                                <textarea name="body" class="w-full text-sm focus:outline-none focus:ring" cols="30" rows="5" placeholder="Write something"></textarea>
                            </div>
